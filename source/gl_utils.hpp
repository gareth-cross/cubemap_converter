...
// Wrapper for texture arrays.
struct TextureArray : public OpenGLHandle {
  TextureArray();
...
[[maybe_unused]] inline constexpr glm::fquat GetFaceRotation(const int face) {
  ...
  constexpr std::array<glm::fquat, 6> cube_R_face = {
    make_quat_xyzw(0, 0.70710678f, 0, 0.70710678f),   // + x
    make_quat_xyzw(0, -0.70710678f, 0, 0.70710678f),  // - x
    make_quat_xyzw(-0.70710678f, 0, 0, 0.70710678f),  // + y
    make_quat_xyzw(0.70710678f, 0, 0, 0.70710678f),   // - y
